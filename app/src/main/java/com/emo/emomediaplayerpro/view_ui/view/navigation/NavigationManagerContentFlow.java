...
import com.emo.emomediaplayerpro.view_ui.view.fragments.ListPlaylistFragment;
import com.emo.emomediaplayerpro.view_ui.view.fragments.ListTrackFragment;
import com.emo.emomediaplayerpro.view_ui.view.fragments.NavFolderFragment;
import com.emo.emomediaplayerpro.view_ui.view.fragments.NavLibraryFragment;
import com.emo.emomediaplayerpro.view_ui.view.fragments.NavPlayBackFragment;
import com.emo.emomediaplayerpro.view_ui.view.fragments.VideoPlaybackFragment;
import com.emo.emomediaplayerpro.view_ui.view.fragments.VideoTracksListFragment;
...
public final class NavigationManagerContentFlow extends BaseNavigationManager {
    ...
    public void CloudNaatsFragment_Start()
    {
        //Fragment fragment = NaatCloudFragment.newInstance(null,null);
        //open(fragment,false,true);
    }
    ...
    {
        Fragment ListAlbumsFragment = com.emo.emomediaplayerpro.view_ui.view.fragments.ListAlbumsFragment.newInstance();
        open(ListAlbumsFragment, false, true);
    }

    public void startArtistFragment()
    {
        Fragment ArtistFrag = com.emo.emomediaplayerpro.view_ui.view.fragments.ListArtistFragment.newInstance();
        open(ArtistFrag, false, true);
    }

    public void startGenreFragment()
    {
        Fragment GenreFrag = com.emo.emomediaplayerpro.view_ui.view.fragments.ListGenreFragment.newInstance();

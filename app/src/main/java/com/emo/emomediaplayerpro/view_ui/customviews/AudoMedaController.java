...
public class AudoMedaController extends LinearLayoutCompat implements View.OnClickListener {
    ...
    private AppCompatImageButton btn_repeat;
    private AppCompatImageButton btn_shuffle;
    ...
    {
        /* Inflate the view file for this custom View */
        ...
        btn_repeat  = (AppCompatImageButton) rootView.findViewById(R.id.btn_repeat_audioControl);
        btn_shuffle = (AppCompatImageButton) rootView.findViewById(R.id.btn_shuffle_audioControl);
    ...
    public void onClick(View v)
    {
        ...
        {
            touchEventsUtilizer.onPlayButton_Click();
        } else if (v.getId() == R.id.btn_FastForward)
        {
            touchEventsUtilizer.onFastForward_Click();
        } else if (v.getId() == R.id.btn_FastRewind)
        {
            touchEventsUtilizer.onFastRewind_Click();

        } else if (v.getId() == R.id.btn_SkipNext)
        {
            touchEventsUtilizer.onSkipNext_Click();
        } else if (v.getId() == R.id.btn_SkipPrev)
        {
            touchEventsUtilizer.onSkipPrev_Click();
        }
        else if (v.getId() == R.id.btn_repeat_audioControl)
        {
            touchEventsUtilizer.onRepeatSelected(v);
        }
        else if (v.getId() == R.id.btn_shuffle_audioControl)
        {
            touchEventsUtilizer.onShuffleSelected(v);
        }
    }
    ...
    public interface AudoMedaControllerTouchEventsListener {
        ...
        void onRepeatSelected(View button);

        void onShuffleSelected(View button);
    }
}

...
import com.emo.emomediaplayerpro.middlelayer.actioners.ToneVolStereoActions;
import com.emo.emomediaplayerpro.view_ui.viewmodel.EqualizerViewModel;
import com.emo.emomediaplayerpro.view_ui.customviews.KnobController;
import com.emo.emomediaplayerpro.view_ui.view.fragments.NavEqualizerFragment;
...
import com.emo.emomediaplayerpro.view_ui.view.navigation.NavigationManagerSettingsFlow;
...
public class EqualizerActivity extends BaseActivity implements BottomNavigationView.OnNavigationItemSelectedListener, View.OnClickListener {
    ...
    private void setupActivityView()
    {
        ...
        // ToDo: yahan men button (save and reset)disable krha hun sb, qk shuru men tone+mono+volume wala
        // fragment open hota he..
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item)
    {
        switch (item.getItemId())
        {
            case R.id.navMenu_toEqualizerFrag_EqualizerActivity:
                // ToDo: yahan men button (save and reset) Enable krha hun sb..
            ...
            case R.id.navMenu_toToneAndVolFrag_EqualizerActivity:
                // ToDo: yahan men button (save and reset)disable krha hun sb..
                btn_save.setEnabled(false);
                btn_reset.setEnabled(false);

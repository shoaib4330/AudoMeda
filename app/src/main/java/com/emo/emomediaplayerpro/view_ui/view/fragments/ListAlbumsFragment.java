...
import com.emo.emomediaplayerpro.view_ui.viewmodel.AlbumsListingViewModel;
...
public class ListAlbumsFragment extends Fragment implements AlbumsListingViewModel.AlbumsControllerEventsListener {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        albumRecyclerAdapter = new ListAlbumsFragment.AlbumRecyclerAdapter(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                frag_NavigationManager.startListTracksFragment(null, (collectionList.get((int) v.getTag())).getAlbumTitle(), null,null);
            }
        });
    }
    ...
    @Override
    public void onAlbumListProvision(List<Collection> list)
    {
    ...
    private static class AlbumRecyclerAdapter extends RecyclerView.Adapter<ListAlbumsFragment.AlbumRecyclerAdapter.AlbumViewHolder> {
        ...
        public static class AlbumViewHolder extends RecyclerView.ViewHolder {
            ...
            public void bind(Collection collection, int position)
            {
                ...
                tv_albumTitle.setText(collection.getAlbumTitle());
                tv_albumArtist.setText(collection.getAlbumArtist());
                if (collection.getAlbumArtURI() == null)
                {
                    iv_albumImage.setImageResource(R.drawable.album_default_ico);
                } else
                {
                    iv_albumImage.setImageBitmap(BitmapFactory.decodeFile(collection.getAlbumArtURI()));
                }
        ...
        private List<Collection> adapterCollectionList;
        ...
        public void updateFoldersList(List<Collection> collectionList)
        {
            this.adapterCollectionList = collectionList;
        ...
        {
            holder.bind(this.adapterCollectionList.get(position), position);
        }

        @Override
        public int getItemCount()
        {
            if (this.adapterCollectionList != null)
                return this.adapterCollectionList.size();
            return 0;
        }
    }
}

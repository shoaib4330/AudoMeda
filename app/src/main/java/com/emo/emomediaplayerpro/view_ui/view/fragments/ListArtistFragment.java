...
import com.emo.emomediaplayerpro.model.data_layer.content_providers.ArtistsLoader;
import com.emo.emomediaplayerpro.model.data_layer.content_providers.Specification.ArtistSpecification;
...
public class ListArtistFragment extends Fragment implements ArtistsLoader.MediaProviderEventsListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        artistRecyclerAdapter = new ArtistRecyclerAdapter(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(getContext(),(naatKhawanList.get( (int)v.getTag() )).getArtistName(),Toast.LENGTH_SHORT).show();
                frag_NavigationManager.startListTracksFragment(null,null, naatKhawanList.get((int)v.getTag()).getArtistName(),null);
            }
        });
    ...
    @Override
    public void onListCreated(List<NaatKhawan> list) {
        this.naatKhawanList = list;
    ...
    private static class ArtistRecyclerAdapter extends RecyclerView.Adapter<ListArtistFragment.ArtistRecyclerAdapter.ArtistViewHolder> {
        ...
        public static class ArtistViewHolder extends RecyclerView.ViewHolder {
            ...
            public void bind(NaatKhawan naatKhawan, int position) {
                this.itemView.setTag(position); /* shoaib: to get clicked item position */
                tv_artistName.setText(naatKhawan.getArtistName());
                tv_artistTotalTracks.setText(String.valueOf(naatKhawan.getNumOfTracks()));
        ...
        private List<NaatKhawan> adapterNaatKhawanList;
        ...
        public void updateFoldersList(List<NaatKhawan> artistsList) {
            this.adapterNaatKhawanList = artistsList;
        ...
        public void onBindViewHolder(ListArtistFragment.ArtistRecyclerAdapter.ArtistViewHolder holder, int position) {
            holder.bind(this.adapterNaatKhawanList.get(position), position);
        }

        @Override
        public int getItemCount() {
            if (this.adapterNaatKhawanList != null)
                return this.adapterNaatKhawanList.size();
            return 0;
        }
    }
}

...
import com.emo.emomediaplayerpro.view_ui.view.NagizarActivity;
import com.h6ah4i.android.media.IBasicMediaPlayer;

import java.io.IOException;
import java.util.List;

import static com.emo.emomediaplayerpro.model.domain.androidservices.MediaControllerService.Constants.ServiceSentActionConstants.ACTION_SEEKBAR_UPDATE;
import static com.emo.emomediaplayerpro.model.domain.androidservices.MediaControllerService.Constants.ServiceSentActionConstants.TAG_INTENT_PROGRESS_INTEGER;
...
public class MediaControllerService extends Service implements MediaControllerInterface, IBasicMediaPlayer.OnCompletionListener,
    ...
    public interface Constants {
        String MAIN_ACTION = "com.emo.naatcloud.action.main";
        String PREV_ACTION = "com.emo.naatcloud.action.prev";
        String PLAY_ACTION = "com.emo.naatcloud.action.play";
        String PAUSE_ACTION = "com.emo.naatcloud.action.pause"; //Notification does not use this one
        String NEXT_ACTION = "com.emo.naatcloud.action.next";
        String STOP_ACTION = "com.emo.naatcloud.action.stop";
        ...
        interface ServiceSentActionConstants {
            String ACTION_SERVICE_CHANGES_TRACK = "com.emo.naatcloud.action.connectionclient.trackchanged";
            String ACTION_SERVICE_PLAYS_TRACK = "com.emo.naatcloud.action.connectionclient.trackplayed";
            String ACTION_SERVICE_STOPS_TRACK = "com.emo.naatcloud.action.connectionclient.trackstopped";
            String ACTION_SEEKBAR_UPDATE = "com.emo.naatcloud_local_CURRENTSEEKPOSITION_update";
            String ACTION_REPEAT_SWITCHED = "com.emo.naatcloud.connectionclient.repeatswitch";
            String ACTION_SHUFFLE_SWITCHED = "com.emo.naatcloud.connectionclient.shuffleswitch";
            String INTENT_EXTRA_TRACKINDEX_INT = "com.emo.naatcloud.action.connectionclient.trackIndex";
            String TAG_INTENT_PROGRESS_INTEGER = "currentProgress";
        }

        interface ServiceReceivedAction {
            String REPEAT_SWITCH_ACTION_REC = "com.emo.naatcloud.action.repeat_switch";
            String SHUFFLE_SWITCH_ACTION_REC = "com.emo.naatcloud.action.shuffle_switch";
        }
    }
    ...
    * this class provides and interface for interaction*/
    ...
    private Notification buildNotification()
    {
        ...
        if (Build.VERSION.SDK_INT >= 26)
        {
            ...
            String id = "my_noti_channel0900";
            // The user-visible name of the channel.
            CharSequence name = "EMOMediaPlayer";
            // The user-visible description of the channel.
            String description = "EMOMediaPlayer Alerts";
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this, "my_noti_channel0900")
                .setContentTitle(getResources().getString(R.string.app_name))
                .setContentText(currTrackText).setSmallIcon(R.drawable.icon_app)
                .setLargeIcon(icon)
